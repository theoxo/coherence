...
class mu_1_MessageType: public mu__byte
{
 public:
  ...
  mu_1_MessageType (const char *name, int os): mu__byte(3, 11, 4, name, os) {};
  mu_1_MessageType (void): mu__byte(3, 11, 4) {};
  mu_1_MessageType (int val): mu__byte(3, 11, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const char *mu_1_MessageType::values[] = {"ReadReq","WriteReq","WBReq","AckRead","AckWrite","AckWB","DataReqS","DataReqI","DataNoReqI",NULL };
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_1::values[ int(val) - 12] );
    else return ( s << "Undefined" );
  };

  mu_1__type_1 (const char *name, int os): mu__byte(12, 16, 3, name, os) {};
  mu_1__type_1 (void): mu__byte(12, 16, 3) {};
  mu_1__type_1 (int val): mu__byte(12, 16, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_3: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_3::values[ int(val) - 17] );
    else return ( s << "Undefined" );
  };

  mu_1__type_3 (const char *name, int os): mu__byte(17, 26, 4, name, os) {};
  mu_1__type_3 (void): mu__byte(17, 26, 4) {};
  mu_1__type_3 (int val): mu__byte(17, 26, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const char *mu_1__type_3::values[] = {"PM","PS","PI","PIMad","PIMa","PSMad","PSMa","PMI","PSI","PIIa",NULL };
...
const int mu_DataReqS = 9;
const int mu_DataReqI = 10;
const int mu_DataNoReqI = 11;
const int mu_HM = 12;
const int mu_HS = 13;
const int mu_HI = 14;
const int mu_HSd = 15;
...
const int mu_PS = 18;
const int mu_PI = 19;
const int mu_PIMad = 20;
const int mu_PIMa = 21;
const int mu_PSMad = 22;
const int mu_PSMa = 23;
const int mu_PMI = 24;
const int mu_PSI = 25;
const int mu_PIIa = 26;
